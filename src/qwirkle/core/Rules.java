			...
			if (game.current.getHand().contains(tile)) {
				...
				if (!surrounding.isEmpty()) {
					for (int j = 1; j < 6; j++) {
						...
						if (one && ((!temp1.getShape().equals(tile.getShape())
								&& !temp1.getColor().equals(tile.getColor()))
								|| (temp1.getShape().equals(tile.getShape())
										&& temp1.getColor().equals(tile.getColor())))) {
							allowed = false;
							break;
						}
						...
						if (two && ((!temp2.getShape().equals(tile.getShape())
								&& !temp2.getColor().equals(tile.getColor()))
								|| (temp2.getShape().equals(tile.getShape())
										&& temp2.getColor().equals(tile.getColor())))) {
							allowed = false;
							break;
						}
						...
						if (three && ((!temp3.getShape().equals(tile.getShape())
								&& !temp3.getColor().equals(tile.getColor()))
								|| (temp3.getShape().equals(tile.getShape())
										&& temp3.getColor().equals(tile.getColor())))) {
							allowed = false;
							break;
						}
						...
						if (four && ((!temp4.getShape().equals(tile.getShape())
								&& !temp4.getColor().equals(tile.getColor()))
								|| (temp4.getShape().equals(tile.getShape())
										&& temp4.getColor().equals(tile.getColor())))) {
							allowed = false;
							break;
						}
